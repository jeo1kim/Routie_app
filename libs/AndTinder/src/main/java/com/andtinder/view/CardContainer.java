...
public class CardContainer extends AdapterView<ListAdapter> {
    ...
    ArrayList<CardModel> likes = new ArrayList<CardModel>();
    ArrayList<CardModel> dislikes = new ArrayList<CardModel>();
    ...
    private void ensureFull() {
        while (mNextAdapterPosition < mListAdapter.getCount() && getChildCount() < mMaxVisible) {
            View view = mListAdapter.getView(mListAdapter.getCount() - 1 -mNextAdapterPosition, null, this);
